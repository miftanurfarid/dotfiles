...
alias fuckyou="paru -Syu --noconfirm"
...
#change monitor
alias hm="bash ~/.config/qtile/scripts/home_monitor.sh"
alias wm="bash ~/.config/qtile/scripts/work_monitor.sh"
alias dm="bash ~/.config/qtile/scripts/presentation_duplicate.sh"
alias sm="bash ~/.config/qtile/scripts/single_monitor.sh"
...
if test -f /home/fafa/miniconda3/bin/conda
    eval /home/fafa/miniconda3/bin/conda "shell.fish" "hook" $argv | source
else
    if test -f "/home/fafa/miniconda3/etc/fish/conf.d/conda.fish"
        . "/home/fafa/miniconda3/etc/fish/conf.d/conda.fish"
    else
        set -x PATH "/home/fafa/miniconda3/bin" $PATH
    end
end
# <<< conda initialize <<<
